...
class Game:
    def __init__(self, screen, active_sprite_list):
        ...
        self.active_sprite_list = active_sprite_list # reference to active sprite list
        self.player = None
    ...
    def initializeLevelList(self):
        self.level_list = [Level1(self.screen, self.player), Level2(self.screen, self.player)]
    ...
    def processEvents(self): # return True if quit, false otherwise
        ...
        self.current_level.update() # update items in the current level
    ...
    def updateLevelIfNeeded(self): # return True if quit, false otherwise
        ...
        if current_position < self.current_level.level_limit:
            if self.current_level_no < len(self.level_list) - 1:
                ...
                return True # quit (out of levels)
